...
function writeText(file, text){
  // pid in the temp name (3/9): replay.js or weekly-bench.js run against the
  // same ROOT as a live server would otherwise share one temp path with it
  // and clobber each other's half-written bytes before either rename lands
  // (server.js writeJSONAtomic has carried the pid since 27/7)
